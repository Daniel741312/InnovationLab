...
static void step_motor_test() {
    ...
    sm0->RotateClockwise(128);
    sm0->Stop();
    sm0->RotateAntiClockwise(128);
    sm0->Stop();
...
static void tcp_send_test() {
    tcp_send::TCPClient* tcpclient0=new tcp_send::TCPClient("192.168.0.3",9526);
